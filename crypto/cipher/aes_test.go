...
func TestAesCipher_SetKey(t *testing.T) {
	t.Run("set 16-byte key (AES-128)", func(t *testing.T) {
		cipher := NewAesCipher(CBC)
		key := make([]byte, 16)
		cipher.SetKey(key)
	...
	t.Run("set 24-byte key (AES-192)", func(t *testing.T) {
		cipher := NewAesCipher(CBC)
		key := make([]byte, 24)
		cipher.SetKey(key)
		assert.Equal(t, key, cipher.Key)
	...
	t.Run("set 32-byte key (AES-256)", func(t *testing.T) {
		cipher := NewAesCipher(CBC)
		key := make([]byte, 32)
		cipher.SetKey(key)
		assert.Equal(t, key, cipher.Key)
...
func TestAesCipher_SetIV(t *testing.T) {
	t.Run("set 16-byte IV", func(t *testing.T) {
		cipher := NewAesCipher(CBC)
		iv := make([]byte, 16)
		cipher.SetIV(iv)
		assert.Equal(t, iv, cipher.IV)
		assert.Equal(t, 16, len(cipher.IV))
	})
...
func TestAesCipher_SetNonce(t *testing.T) {
	...
	t.Run("set 16-byte nonce", func(t *testing.T) {
		cipher := NewAesCipher(GCM)
		nonce := make([]byte, 16)
		cipher.SetNonce(nonce)
		assert.Equal(t, nonce, cipher.Nonce)
		assert.Equal(t, 16, len(cipher.Nonce))
	})
...
func TestAesCipher_Integration(t *testing.T) {
...
func TestAesCipher_EdgeCases(t *testing.T) {
...
func TestAesCipher_FieldAccess(t *testing.T) {
