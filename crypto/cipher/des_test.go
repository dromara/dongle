...
func TestDesCipher_SetKey(t *testing.T) {
	t.Run("set 8-byte key (DES)", func(t *testing.T) {
		cipher := NewDesCipher(CBC)
		key := make([]byte, 8)
		cipher.SetKey(key)
	...
	t.Run("change key multiple times", func(t *testing.T) {
		...
		key2 := []byte{9, 10, 11, 12, 13, 14, 15, 16}
		cipher.SetKey(key2)
...
func TestDesCipher_Integration(t *testing.T) {
...
func TestDesCipher_EdgeCases(t *testing.T) {
...
func TestDesCipher_FieldAccess(t *testing.T) {
