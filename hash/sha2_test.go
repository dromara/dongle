...
func TestHasher_BySha2_Hash(t *testing.T) {
	t.Run("hash string 224", func(t *testing.T) {
		...
		hasher2 := NewHasher().FromString(string(sha2HashSrc)).BySha2(224)
	...
	t.Run("hash string 256", func(t *testing.T) {
		...
		hasher2 := NewHasher().FromString(string(sha2HashSrc)).BySha2(256)
		assert.Nil(t, hasher2.Error)
	...
	t.Run("hash string 384", func(t *testing.T) {
		...
		hasher2 := NewHasher().FromString(string(sha2HashSrc)).BySha2(384)
		assert.Nil(t, hasher2.Error)
	...
	t.Run("hash string 512", func(t *testing.T) {
		...
		hasher2 := NewHasher().FromString(string(sha2HashSrc)).BySha2(512)
		assert.Nil(t, hasher2.Error)
	...
	t.Run("hash bytes", func(t *testing.T) {
		...
		hasher2 := NewHasher().FromBytes(sha2HashSrc).BySha2(256)
		assert.Nil(t, hasher2.Error)
		assert.Equal(t, sha2Hash256Base64Dst, hasher2.ToBase64String())
	})
	...
	t.Run("hash file", func(t *testing.T) {
		...
		file2 := mock.NewFile(sha2HashSrc, "test2.txt")
		hasher2 := NewHasher().FromFile(file2).BySha2(256)
		assert.Nil(t, hasher2.Error)
		assert.Equal(t, sha2Hash256Base64Dst, hasher2.ToBase64String())
	})
	...
	t.Run("hash large data", func(t *testing.T) {
		...
		expectedHasher := NewHasher().FromString(data).BySha2(256)
	...
	t.Run("hash unicode data", func(t *testing.T) {
		...
		expectedHasher := NewHasher().FromString(unicodeData).BySha2(256)
		assert.Nil(t, expectedHasher.Error)
		expectedHex := expectedHasher.ToHexString()
		assert.Equal(t, expectedHex, hasher.ToHexString())
	})
	...
	t.Run("hash binary data", func(t *testing.T) {
		...
		expectedHasher := NewHasher().FromBytes(binaryData).BySha2(256)
		assert.Nil(t, expectedHasher.Error)
		expectedHex := expectedHasher.ToHexString()
		assert.Equal(t, expectedHex, hasher.ToHexString())
	})
...
func TestHasher_BySha2_HMAC(t *testing.T) {
	t.Run("hmac string 224", func(t *testing.T) {
		...
		hasher2 := NewHasher().FromString(string(sha2HmacSrc)).WithKey(sha2HmacKey).BySha2(224)
		assert.Nil(t, hasher2.Error)
	...
	t.Run("hmac string 256", func(t *testing.T) {
		...
		hasher2 := NewHasher().FromString(string(sha2HmacSrc)).WithKey(sha2HmacKey).BySha2(256)
		assert.Nil(t, hasher2.Error)
	...
	t.Run("hmac string 384", func(t *testing.T) {
		...
		hasher2 := NewHasher().FromString(string(sha2HmacSrc)).WithKey(sha2HmacKey).BySha2(384)
		assert.Nil(t, hasher2.Error)
	...
	t.Run("hmac string 512", func(t *testing.T) {
		...
		hasher2 := NewHasher().FromString(string(sha2HmacSrc)).WithKey(sha2HmacKey).BySha2(512)
		assert.Nil(t, hasher2.Error)
	...
	t.Run("hmac bytes", func(t *testing.T) {
		...
		hasher2 := NewHasher().FromBytes(sha2HmacSrc).WithKey(sha2HmacKey).BySha2(256)
		assert.Nil(t, hasher2.Error)
		assert.Equal(t, sha2Hmac256Base64Dst, hasher2.ToBase64String())
	})
	...
	t.Run("hmac file", func(t *testing.T) {
		...
		file2 := mock.NewFile(sha2HmacSrc, "test2.txt")
		hasher2 := NewHasher().FromFile(file2).WithKey(sha2HmacKey).BySha2(256)
		assert.Nil(t, hasher2.Error)
		assert.Equal(t, sha2Hmac256Base64Dst, hasher2.ToBase64String())
	})
	...
	t.Run("hmac empty string", func(t *testing.T) {
		...
		expectedHasher := NewHasher().FromString("").WithKey(sha2HmacKey).BySha2(256)
		assert.Nil(t, expectedHasher.Error)
		expectedHex := expectedHasher.ToHexString()
		assert.Equal(t, expectedHex, hasher.ToHexString())
	})
	...
	t.Run("hmac empty bytes", func(t *testing.T) {
		...
		expectedHasher := NewHasher().FromBytes([]byte{}).WithKey(sha2HmacKey).BySha2(256)
		assert.Nil(t, expectedHasher.Error)
		expectedHex := expectedHasher.ToHexString()
		assert.Equal(t, expectedHex, hasher.ToHexString())
	})
	...
	t.Run("hmac large data", func(t *testing.T) {
		...
		expectedHasher := NewHasher().FromString(data).WithKey(sha2HmacKey).BySha2(256)
		assert.Nil(t, expectedHasher.Error)
		expectedHex := expectedHasher.ToHexString()
		assert.Equal(t, expectedHex, hasher.ToHexString())
	})
	...
	t.Run("hmac unicode data", func(t *testing.T) {
		...
		expectedHasher := NewHasher().FromString(unicodeData).WithKey(sha2HmacKey).BySha2(256)
		assert.Nil(t, expectedHasher.Error)
		expectedHex := expectedHasher.ToHexString()
		assert.Equal(t, expectedHex, hasher.ToHexString())
	})
	...
	t.Run("hmac binary data", func(t *testing.T) {
		...
		expectedHasher := NewHasher().FromBytes(binaryData).WithKey(sha2HmacKey).BySha2(256)
		assert.Nil(t, expectedHasher.Error)
		expectedHex := expectedHasher.ToHexString()
		assert.Equal(t, expectedHex, hasher.ToHexString())
	})
	...
	t.Run("hmac empty file", func(t *testing.T) {
		...
		expectedHasher := NewHasher().FromFile(file2).WithKey(sha2HmacKey).BySha2(256)
		assert.Nil(t, expectedHasher.Error)
		expectedHex := expectedHasher.ToHexString()
		assert.Equal(t, expectedHex, hasher.ToHexString())
	})
	...
	t.Run("hmac with large key", func(t *testing.T) {
		...
		expectedHasher := NewHasher().FromString(string(sha2HmacSrc)).WithKey([]byte(largeKey)).BySha2(256)
		assert.Nil(t, expectedHasher.Error)
		expectedHex := expectedHasher.ToHexString()
		assert.Equal(t, expectedHex, hasher.ToHexString())
	})
